...
int main(int argc, char** argv) {
    ...
    do {
        ...
        cout << "3 -> Calculate Rate of Inflation" << endl;
        cout << "etc....." << endl;
        ...
        switch (option) {
            ...
            case '3': 
                // Call the function for option 3
                {
                    ...
                    do {
                        // Variables
                        float currentPrice, yearAgoPrice;
                        ...
                        // Calculate and output inflation rate 
                        cout << fixed << setprecision(2);
                        cout << "Inflation rate: " << calculateInflation(currentPrice, yearAgoPrice) << "%" << endl;
                        cout << endl;
